  ...
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
      ...
      <p>
        ...
        movieenthusiasts who have come together to create a one-stop destination
        for all your movie-realted needs.
      </p>
      <p>
        Our website is disgned to provide you with a comprehensive database of
      ...
      <p>
        ...
        looking for ways to improve ans enhance the user experience on our
